...
setwd("/ibex/scratch/qadirga/Project_4/Data_Application/GneitingModel")
#setwd("/Users/qadirga/Documents/Project 4-Spacetime modeling/Revisit/Simulation Study/Revisit2/Revisit 3/Data Application/GneitingModel")
...
#############################################
save.image("Oregan_gm_p01.RData")
load("Oregan_gm_p01.RData")
...
save.image("gmtemp_mlep1.RData")
load("gmtemp_mlep1.RData")
...
adhoc_temp<-zeta(t=tseq[1:tdays],nus=rep(myspace.estims$par[2],tdays),alphas = rep(myspace.estims$par[1],tdays),a=tempporal.est$par[1],alpha =tempporal.est$par[2],beta = tempporal.est$par[3],
                 beta2 = tempporal.est$par[4],c.p = mean(rep(myspace.estims$par[1],tdays)))
