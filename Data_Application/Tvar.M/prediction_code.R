...
load("Myrcl_ests_gm_ini5_1.RData")
...
mat.a<-alpha.func(t=tseq[1:tdays],params = rcl.est$par[1:3])
plot(tseq[1:tdays],ls.a,xlim=c(0,1),ylim=c(0,1),type="l")
lines(tseq[1:tdays],mat.a,col="green")
mat.a.full<-alpha.func(t=tseq,params = rcl.est$par[1:3])
mat.nu.full<-nu.func(t=tseq,params = rcl.est$par[4:6])
mat.nu<-nu.func(t=tseq[1:tdays],params = rcl.est$par[4:6])
plot(tseq[1:tdays],ls.nu,xlim=c(0,1),type="l")
lines(tseq[1:tdays],mat.nu,col="green")
mat.sigma<-rcl.est$par[7]

bern.a<-rcl.est$par[8]
bern.alpha<-rcl.est$par[9]
bern.beta1<-rcl.est$par[10]
bern.beta2<-rcl.est$par[11]
...
image.plot(tseq,tseq,myzeta.forc)
...
save.image("MyModel_Prediction_summary5_120f.RData")
...
save.image("MyModel_Prediction_summary5_120fv2.RData")
getwd()
