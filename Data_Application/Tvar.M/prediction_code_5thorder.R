...
setwd("D:/Project 4 Space time modeling/iowa/Data Application/MyModel")

load("Myrcl_ests_gm_ini6_2b-1.RData")
...
mat.a<-alpha.func(t=tseq[1:tdays],params = rcl.est$par[1:5])
plot(tseq[1:tdays],ls.a,xlim=c(0,1),ylim=c(0,1),type="l")
lines(tseq[1:tdays],mat.a,col="green")
mat.a.full<-alpha.func(t=tseq,params = rcl.est$par[1:5])
mat.nu.full<-nu.func(t=tseq,params = rcl.est$par[6:10])
mat.nu<-nu.func(t=tseq[1:tdays],params = rcl.est$par[6:10])
plot(tseq[1:tdays],ls.nu,xlim=c(0,1),type="l")
lines(tseq[1:tdays],mat.nu,col="green")
mat.sigma<-rcl.est$par[11]

bern.a<-rcl.est$par[12]
bern.alpha<-rcl.est$par[13]
bern.beta1<-rcl.est$par[14]
bern.beta2<-rcl.est$par[15]
...
myfas.forc<-f_alphas(t=tseq,alphas = mat.a.full,a=bern.a,alpha=bern.alpha,beta=bern.beta1,c.p = mean(mat.a))
myzeta.forc<-zeta(t=tseq,nus =mat.nu.full,alphas = mat.a.full,a=bern.a,alpha=bern.alpha,beta=bern.beta1,beta2 =bern.beta2,c.p = mean(mat.a) )
mynus.forc<-outer(mat.nu.full,mat.nu.full,function(x,y) (x+y)/2)
...
save.image("MyModel_Prediction_summary62_320f.RData")
...
save.image("MyModel_Prediction_summary6b20fv2.RData")
