####### Result combiner #####
setwd("/Users/qadirga/Documents/Project 4-Spacetime modeling/Revisit/Simulation Study/Revisit2/Revisit 3/case3_2/FInal piece of codes")
...
c2my_crps_pred<-my_crps_pred
c2gm_crps_pred<-gm_crps_pred
c2sp_crps_pred<-sp_crps_pred

c2my_crps_forc<-my_crps_forc
c2gm_crps_forc<-gm_crps_forc
c2sp_crps_forc<-sp_crps_forc


c2my_logs_pred<-my_logs_pred
c2gm_logs_pred<-gm_logs_pred
c2sp_logs_pred<-sp_logs_pred

c2my_logs_forc<-my_logs_forc
c2gm_logs_forc<-gm_logs_forc
c2sp_logs_forc<-sp_logs_forc
...
c2myrmse_int<-myrmse_int
c2gmrmse_int<-gmrmse_int
c2sprmse_int<-sprmse_int


c2myrmse_forc<-myrmse_forc
c2gmrmse_forc<-gmrmse_forc
c2sprmse_forc<-sprmse_forc


c2mykp_pred<-mykp_pred
c2gmkp_pred<-gmkp_pred
c2skp_pred<-skp_pred


c2mywp_pred<-mywp_pred
c2gmwp_pred<-gmwp_pred
c2swp_pred<-swp_pred

c2mykp_forc<-mykp_forc
c2gmkp_forc<-gmkp_forc
c2skp_forc<-skp_forc

c2mywp_forc<-mywp_forc
c2gmwp_forc<-gmwp_forc
c2swp_forc<-swp_forc



undelete<-c("c2my_crps_pred",
            "c2gm_crps_pred",
            "c2sp_crps_pred",
            "c2my_crps_forc",
            "c2gm_crps_forc",
