...
#setwd("/Users/qadirga/Documents/Project 4-Spacetime modeling/Revisit/Simulation Study/Revisit2/Revisit 3/Case3_2/FInal piece of codes/SeparableModel")
library(MASS)
library(mvtnorm)
library(fields)
library(doParallel)
...
setwd("/ibex/scratch/qadirga/Project_4/Simulation_study_rev3/Case3_2/SeparableModel")
