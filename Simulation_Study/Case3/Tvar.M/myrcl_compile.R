...
#setwd("/Users/qadirga/Documents/Project 4-Spacetime modeling/Revisit/Simulation Study/Revisit2/Revisit 3/Case3_2/FInal piece of codes/MyModel")
library(MASS)
library(mvtnorm)
library(fields)
library(doParallel)
...
c2true_alpha<-alphas
c2myalpha.mean<-myest.a.rcl.mean
c2myalpha.sd<-myest.a.rcl.sd
c2true_nus<-nus
c2mynu.mean<-myest.nu.rcl.mean
c2mynu.sd<-myest.nu.rcl.sd

#rm(list = ls()[!ls()%in%c("tseq","c2true_alpha","c2myalpha.mean","c2myalpha.sd","c2true_nus","c2mynu.mean","c2mynu.sd")])
#save.image("c2myalphnu.RData")
