####### Result combiner #####
setwd("/Users/qadirga/Documents/Project 4-Spacetime modeling/Revisit/Simulation Study/Revisit2/Revisit 3/case4_2/FInal piece of codes")
...
############ Saving all the summary data with c3prefix #######

c3my_crps_pred<-my_crps_pred
c3gm_crps_pred<-gm_crps_pred
c3sp_crps_pred<-sp_crps_pred

c3my_crps_forc<-my_crps_forc
c3gm_crps_forc<-gm_crps_forc
c3sp_crps_forc<-sp_crps_forc


c3my_logs_pred<-my_logs_pred
c3gm_logs_pred<-gm_logs_pred
c3sp_logs_pred<-sp_logs_pred

c3my_logs_forc<-my_logs_forc
c3gm_logs_forc<-gm_logs_forc
c3sp_logs_forc<-sp_logs_forc
...
c3myrmse_int<-myrmse_int
c3gmrmse_int<-gmrmse_int
c3sprmse_int<-sprmse_int


c3myrmse_forc<-myrmse_forc
c3gmrmse_forc<-gmrmse_forc
c3sprmse_forc<-sprmse_forc


c3mykp_pred<-mykp_pred
c3gmkp_pred<-gmkp_pred
c3skp_pred<-skp_pred


c3mywp_pred<-mywp_pred
c3gmwp_pred<-gmwp_pred
c3swp_pred<-swp_pred

c3mykp_forc<-mykp_forc
c3gmkp_forc<-gmkp_forc
c3skp_forc<-skp_forc

c3mywp_forc<-mywp_forc
c3gmwp_forc<-gmwp_forc
c3swp_forc<-swp_forc



undelete<-c("c3my_crps_pred",
            "c3gm_crps_pred",
            "c3sp_crps_pred",
            "c3my_crps_forc",
            "c3gm_crps_forc",
