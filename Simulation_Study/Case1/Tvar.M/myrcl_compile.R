...
#setwd("/Users/qadirga/Documents/Project 4-Spacetime modeling/Revisit/Simulation Study/Revisit2/Revisit 3/Case1_2/FInal piece of codes/MyModel")
library(MASS)
library(mvtnorm)
library(fields)
library(doParallel)
...
c1true_alpha<-alphas
c1myalpha.mean<-myest.a.rcl.mean
c1myalpha.sd<-myest.a.rcl.sd
c1true_nus<-nus
c1mynu.mean<-myest.nu.rcl.mean
c1mynu.sd<-myest.nu.rcl.sd

#rm(list = ls()[!ls()%in%c("tseq","c1true_alpha","c1myalpha.mean","c1myalpha.sd","c1true_nus","c1mynu.mean","c1mynu.sd")])
#save.image("c1myalphnu.RData")
