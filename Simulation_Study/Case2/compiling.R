####### Result combiner #####
setwd("/Users/qadirga/Documents/Project 4-Spacetime modeling/Revisit/Simulation Study/Revisit2/Revisit 3/case2_2/FInal piece of codes")
...
c4my_crps_pred<-my_crps_pred
c4gm_crps_pred<-gm_crps_pred
c4sp_crps_pred<-sp_crps_pred

c4my_crps_forc<-my_crps_forc
c4gm_crps_forc<-gm_crps_forc
c4sp_crps_forc<-sp_crps_forc


c4my_logs_pred<-my_logs_pred
c4gm_logs_pred<-gm_logs_pred
c4sp_logs_pred<-sp_logs_pred

c4my_logs_forc<-my_logs_forc
c4gm_logs_forc<-gm_logs_forc
c4sp_logs_forc<-sp_logs_forc
...
c4myrmse_int<-myrmse_int
c4gmrmse_int<-gmrmse_int
c4sprmse_int<-sprmse_int


c4myrmse_forc<-myrmse_forc
c4gmrmse_forc<-gmrmse_forc
c4sprmse_forc<-sprmse_forc


c4mykp_pred<-mykp_pred
c4gmkp_pred<-gmkp_pred
c4skp_pred<-skp_pred


c4mywp_pred<-mywp_pred
c4gmwp_pred<-gmwp_pred
c4swp_pred<-swp_pred

c4mykp_forc<-mykp_forc
c4gmkp_forc<-gmkp_forc
c4skp_forc<-skp_forc

c4mywp_forc<-mywp_forc
c4gmwp_forc<-gmwp_forc
c4swp_forc<-swp_forc



undelete<-c("c4my_crps_pred",
            "c4gm_crps_pred",
            "c4sp_crps_pred",
            "c4my_crps_forc",
            "c4gm_crps_forc",
